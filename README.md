...
- [Язык программирования Half68k (CISC ASM)](#язык-программирования-half68k-cisc-asm)
- [Организация памяти](#организация-памяти)
- [Система команд](#система-команд)
    - [Формат инструкций](#формат-инструкций)
    - [Набор инструкций](#набор-инструкций-и-такты)
    - [Кодирование инструкций](#кодирование-инструкций)
- [Транслятор](#транслятор)
- [Модель процессора](#модель-процессора)
    - [DataPath (Тракт данных)](#datapath-тракт-данных)
    - [Control Unit (Устройство управления)](#control-unit-устройство-управления)
...
**Пример запуска:**
```bash
python translator.py tests/hello/hello.s tests/hello/hello.bin
```
...
#### 1. Препроцессор ([preprocessor.py](preprocessor.py))
...
Скомпонованные списки слов данных и кода записываются в бинарный файл: сначала заголовок (количество слов данных и адрес начала кода), затем данные, затем код. Параллельно формируется текстовый дамп с адресами и HEX-кодами.
